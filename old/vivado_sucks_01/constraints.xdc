...
#                                               Header P4                                                         #
###################################################################################################################
#set_property -dict {PACKAGE_PIN E12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[0]}]
#set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[1]}]
#set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[2]}]
#set_property -dict {PACKAGE_PIN D16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[3]}]
#set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[4]}]
#set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[5]}]
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[6]}]
#set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[7]}]
#set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[8]}]
#set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[9]}]
#set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[10]}]
#set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[11]}]
#set_property -dict {PACKAGE_PIN F12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[12]}]
#set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[13]}]
#set_property -dict {PACKAGE_PIN H12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[14]}]
#set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {PROBE_ad_x[15]}]
#set_property -dict {PACKAGE_PIN H11 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports PROBE_read_n_x]
#set_property -dict {PACKAGE_PIN G12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports PROBE_ale_l_x]
#set_property -dict {PACKAGE_PIN M5 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports PROBE_ale_h_x]
