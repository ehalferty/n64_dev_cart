...
#                                              Header P5                                                          #
###################################################################################################################
set_property -dict  { PACKAGE_PIN "D14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[15]}];                        # IO_L15P_T2_DQS_15             Sch = GPIO_19_P
set_property -dict  { PACKAGE_PIN "D15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[14]}];                        # IO_L15N_T2_DQS_ADV_B_15       Sch = GPIO_19_N
set_property -dict  { PACKAGE_PIN "C14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[13]}];                        # IO_L8P_T1_AD10P_15            Sch = GPIO_20_P
set_property -dict  { PACKAGE_PIN "B14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[12]}];                        # IO_L8N_T1_AD10N_15            Sch = GPIO_20_N
set_property -dict  { PACKAGE_PIN "C11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[11]}];                        # IO_L11P_T1_SRCC_15            Sch = GPIO_22_P
set_property -dict  { PACKAGE_PIN "C12"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[10]}];                        # IO_L11N_T1_SRCC_15            Sch = GPIO_22_N
set_property -dict  { PACKAGE_PIN "H16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[9]}];                        # IO_L22P_T3_A17_15             Sch = GPIO_23_P
set_property -dict  { PACKAGE_PIN "G16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[8]}];                        # IO_L22N_T3_A16_15             Sch = GPIO_23_N
set_property -dict  { PACKAGE_PIN "D8"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[7]}];                       # IO_L6P_T0_15                  Sch = GPIO_29_P
set_property -dict  { PACKAGE_PIN "C9"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[6]}];                       # IO_L1N_T0_AD0N_15             Sch = GPIO_28_N
set_property -dict  { PACKAGE_PIN "C8"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[5]}];                       # IO_L1P_T0_AD0P_15             Sch = GPIO_28P
set_property -dict  { PACKAGE_PIN "B11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[4]}];                       # IO_L4N_T0_15                  Sch = GPIO_27_N
set_property -dict  { PACKAGE_PIN "E11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[3]}];                       # IO_L14P_T2_SRCC_15            Sch = GPIO_26_P
set_property -dict  { PACKAGE_PIN "A15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[2]}];                       # IO_L9N_T1_DQS_AD3N_15         Sch = GPIO_25_N
set_property -dict  { PACKAGE_PIN "B15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[1]}];                       # IO_L9P_T1_DQS_AD3P_15         Sch = GPIO_25_P
set_property -dict  { PACKAGE_PIN "B16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_AD[0]}];                       # IO_L10N_T1_AD11N_15           Sch = GPIO_24_N
set_property -dict  { PACKAGE_PIN "C13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_READ_N}];                        # IO_L12N_T1_MRCC_15            Sch = GPIO_21_N
...
set_property -dict  { PACKAGE_PIN "C16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_INT4}];                       # IO_L10P_T1_AD11P_15           Sch = GPIO_24_P
set_property -dict  { PACKAGE_PIN "B10"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_ALE_H}];                       # IO_L4P_T0_15                  Sch = GPIO_27_P
set_property -dict  { PACKAGE_PIN "D11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_ALE_L}];                       # IO_L14N_T2_SRCC_15            Sch = GPIO_26_N
