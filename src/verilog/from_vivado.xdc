...
#                                               CLOCK 100MHz                                                       #
####################################################################################################################
set_property PACKAGE_PIN N11 [get_ports CLK1]
...
#                                               Push Buttons                                                       #
####################################################################################################################
set_property -dict { PACKAGE_PIN "F5"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { button1 }];                     # IO_L13P_T2_MRCC_35            Sch = SW0
...
#                                               Header P4                                                         #
###################################################################################################################
set_property -dict  { PACKAGE_PIN "E12"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[1]}];                        # IO_L13P_T2_MRCC_15            Sch = GPIO_1_P
set_property -dict  { PACKAGE_PIN "E13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[0]}];                        # IO_L13N_T2_MRCC_15            Sch = GPIO_1_N
set_property -dict  { PACKAGE_PIN "E16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[3]}];                        # IO_L17P_T2_A26_15             Sch = GPIO_2_P
set_property -dict  { PACKAGE_PIN "D16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[2]}];                        # IO_L17N_T2_A25_15             Sch = GPIO_2_N
set_property -dict  { PACKAGE_PIN "F15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[5]}];                        # IO_L18P_T2_A24_15             Sch = GPIO_3_P
set_property -dict  { PACKAGE_PIN "E15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[4]}];                        # IO_L18N_T2_A23_15             Sch = GPIO_3_N
set_property -dict  { PACKAGE_PIN "G14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[7]}];                        # IO_L21P_T3_DQS_15             Sch = GPIO_4_P
set_property -dict  { PACKAGE_PIN "F14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[6]}];                        # IO_L21N_T3_DQS_A18_15         Sch = GPIO_4_N
set_property -dict  { PACKAGE_PIN "J15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[14}];                         # IO_L23P_T3_FOE_B_15           Sch = GPIO_5_P
set_property -dict  { PACKAGE_PIN "J16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[15]}];                        # IO_L23N_T3_FWE_B_15           Sch = GPIO_5_N
set_property -dict  { PACKAGE_PIN "H14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[12]}];                       # IO_L24P_T3_RS1_15             Sch = GPIO_6_P
set_property -dict  { PACKAGE_PIN "G15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[13]}];                       # IO_L24N_T3_RS0_15             Sch = GPIO_6_N
set_property -dict  { PACKAGE_PIN "F12"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[10]}];                       # IO_L16P_T2_A28_15             Sch = GPIO_7_P
set_property -dict  { PACKAGE_PIN "F13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[11]}];                       # IO_L16N_T2_A27_15             Sch = GPIO_7_N
set_property -dict  { PACKAGE_PIN "H12"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[8]}];                        # IO_L20P_T3_A20_15             Sch = GPIO_8_P
set_property -dict  { PACKAGE_PIN "H13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[9]}];                        # IO_L20N_T3_A19_15             Sch = GPIO_8_N
set_property -dict  { PACKAGE_PIN "H11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_clk}];                       # IO_L19P_T3_A22_15             Sch = GPIO_9_P
set_property -dict  { PACKAGE_PIN "G12"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_dq[12]}];                       # IO_L19N_T3_A21_VREF_15        Sch = GPIO_9_N
set_property -dict  { PACKAGE_PIN "M5"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[11]}];                       # IO_L6P_T0_34                  Sch = GPIO_10_P
set_property -dict  { PACKAGE_PIN "N4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[9]}];                       # IO_L6N_T0_VREF_34             Sch = GPIO_10_N
set_property -dict  { PACKAGE_PIN "T4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[8]}];                       # IO_L9P_T1_DQS_34              Sch = GPIO_11_P
set_property -dict  { PACKAGE_PIN "T3"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[7]}];                       # IO_L9N_T1_DQS_34              Sch = GPIO_11_N
set_property -dict  { PACKAGE_PIN "R3"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[6]}];                       # IO_L8P_T1_34                  Sch = GPIO_12_P
set_property -dict  { PACKAGE_PIN "T2"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[5]}];                       # IO_L8N_T1_34                  Sch = GPIO_12_N
set_property -dict  { PACKAGE_PIN "P4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[4]}];                       # IO_L5P_T0_34                  Sch = GPIO_13_P
set_property -dict  { PACKAGE_PIN "P3"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_we}];                       # IO_L5N_T0_34                  Sch = GPIO_13_N
set_property -dict  { PACKAGE_PIN "R2"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_ras}];                       # IO_L7P_T1_34                  Sch = GPIO_14_P
set_property -dict  { PACKAGE_PIN "R1"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_cas}];                       # IO_L7N_T1_34                  Sch = GPIO_14_N
set_property -dict  { PACKAGE_PIN "N3"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_ba[0]}];                       # IO_L3P_T0_DQS_34              Sch = GPIO_15_P
set_property -dict  { PACKAGE_PIN "N2"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_cs1}];                       # IO_L3N_T0_DQS_34              Sch = GPIO_15_N
set_property -dict  { PACKAGE_PIN "M2"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[10]}];                       # IO_L2P_T0_34                  Sch = GPIO_16_P
set_property -dict  { PACKAGE_PIN "M1"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_ba[1]}];                       # IO_L2N_T0_34                  Sch = GPIO_16_N
set_property -dict  { PACKAGE_PIN "N1"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[1]}];                       # IO_L4P_T0_34                  Sch = GPIO_17_P
set_property -dict  { PACKAGE_PIN "P1"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[0]}];                       # IO_L4N_T0_34                  Sch = GPIO_17_N
set_property -dict  { PACKAGE_PIN "L4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[3]}];                       # IO_L1P_T0_34                  Sch = GPIO_18_P
set_property -dict  { PACKAGE_PIN "M4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {sdram_a[2]}];                       # IO_L1N_T0_34                  Sch = GPIO_18_N


###################################################################################################################
#                                              Header P5                                                          #
###################################################################################################################
# set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[15]}]
# set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[14]}]
# set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[13]}]
# set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[12]}]
# set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[11]}]
# set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[10]}]
# set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[9]}]
# set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[8]}]
# set_property -dict {PACKAGE_PIN D8 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[7]}]
# set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[6]}]
# set_property -dict {PACKAGE_PIN C8 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[5]}]
# set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[4]}]
# set_property -dict {PACKAGE_PIN E11 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[3]}]
# set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[2]}]
# set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[1]}]
# set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports {N64_AD[0]}]
# set_property PACKAGE_PIN C13 [get_ports N64_READ_N]
# set_property IOSTANDARD LVCMOS33 [get_ports N64_READ_N]
# set_property -dict  { PACKAGE_PIN "D13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_WRITE_N}];                        # IO_L12P_T1_MRCC_15            Sch = GPIO_21_P
# set_property -dict  { PACKAGE_PIN "G11"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_COLD_RESTART}];                       # IO_25_15                      Sch = GPIO_35
# set_property -dict  { PACKAGE_PIN "D10"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_CLK}];                       # IO_0_15                       Sch = GPIO_34
# set_property -dict  { PACKAGE_PIN "A14"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_EN}];                       # IO_L7N_T1_AD2N_15             Sch = GPIO_30_N
# set_property -dict  { PACKAGE_PIN "A13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_RST}];                       # IO_L7P_T1_AD2P_15             Sch = GPIO_30_P
# set_property -dict {PACKAGE_PIN C16 IOSTANDARD LVCMOS33 SLEW FAST} [get_ports N64_INT4]
# set_property PACKAGE_PIN B10 [get_ports N64_ALE_H]
# set_property IOSTANDARD LVCMOS33 [get_ports N64_ALE_H]
# set_property PACKAGE_PIN D11 [get_ports N64_ALE_L]
# set_property IOSTANDARD LVCMOS33 [get_ports N64_ALE_L]
# set_property -dict  { PACKAGE_PIN "D9"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {N64_NMI_N}];                       # IO_L6N_T0_VREF_15             Sch = GPIO_29_N
